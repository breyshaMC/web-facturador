...
<head>
    ...
    <style>
        ...
        .z-5 {
            z-index: 5;
            border-radius: 20px;
            box-shadow: 0 2px 8px rgb(39 44 63 / 12%);
        }
        .h-auto {
                        ...
                        <div class="hero-img-wrap position-relative" data-aos="fade-left">
                            ...
                            <ul class="position-absolute animate-element parallax-element shape-service hide-medium">
                                ...
                                <li class="layer" data-depth="0.02">
                                    <img src="assets/img/color-shape/feature-2.svg" alt="shape" class="img-fluid position-absolute color-shape-2 ">
                                </li>
                                <li class="layer" data-depth="0.03">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6">
                        <div class="section-heading text-center mb-5">
                            <h5 class="h6 text-primary">Factura Facil</h5>
                            <h2>Características principales</h2>
                            <p>
                                Mira algunas de las ventajas de trabajar con nosotros
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-lg-between align-items-center">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="app-two-feature-three-img position-relative text-center mt-5 mt-lg-0">
                            ...
                            <img src="img/facturador.svg" alt="app screen" class="position-relative z-5" />
                            <div class="img-peice d-none d-lg-block">
                                <img src="img/comprobantes-emitidos.svg" alt="app screen" class="img-one position-absolute custom-shadow" />
                                <img src="img/comprobantes.svg" alt="app screen" class="img-two position-absolute custom-shadow" />
                ...
                <div class="row align-items-lg-center justify-content-between">
                    ...
                    <i class="ti ti-apps-filled"></i>
                        <div class="mb-4" data-aos="fade-up">
                            ...
                            <p>Si usas nuestro sistema de facturación ya puedes facturas con nuestra aplicación movil.</p>
                        </div>
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="pr-lg-4 position-relative" data-aos="fade-up">
                            ...
                            <!--animated shape end-->
                            <div class="text-center rounded-custom overflow-hidden pt-5 px-3 px-lg-5 mx-lg-auto">
                                
                                <div class="position-relative w-75 mx-auto">
                                    <img class="position-relative z-2 w-100 h-auto" src="img/app-facturafacil-fastura.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                    </div>
